  ...
  return (
    <div className="mt-8 ">
      <div className="flex justify-between items-start">
        <div>
          <h1 className=" font-primaryRegula break-words text-fs-3 font-wt-700 leading-lh-3.5">{doc[0].name}</h1>
      ...
      <div className=" mt-12 ">
        <div className=" ">
          ...
          <div className=" relative  w-full py-6  flex justify-center rounded-lg  transition-all ">
            <Image height={480} width={840} className=" relative border-4 hover:border-primary rounded-lg border-e3e3e3" alt="properties Images" src={`/properties-images/image-covers/${doc[0].imageCover}`} />
          ...
          <div>
            <div className=" mr-12">
              ...
              <div className="mt-12 font-primaryRegular w-full">
                ...
                <p className=" leading-7 py-4 text-fs-1 font-wt-400 text-descp-color  text-left">{doc[0].description}</p>
              </div>
              <div>
