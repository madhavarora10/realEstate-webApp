...
const TopPage = (props: topPageProps) => {
  ...
  return (
    <div className={` element__container w-full bg-primary-bg overflow-hidden ${classes.bgImage}`}>
      ...
      <SubHeading className="  text-fs-3 leading-lh-3.5  lg:w-104 w-full" textContent={heros.subHeading} />
      <Description className=" lg:w-104 w-full text-primaryDark" textContent={heros.descp} />
      ...
      <div className="mt-8 lg:mt-14">
        ...
        <div className=" bg-white w-full lg:w-2/3  py-4 flex-row inline-flex px-8 ">
