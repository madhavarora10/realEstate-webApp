...
export const CardBasic = async (props?:any) => {
  ...
  return (
    <div className="p-3 border-2 border-card-border flex flex-col gap-3">
      <div>
      ...
      <div className="flex justify-between">
        <h1 className=" text-primary font-primaryRegular text-fs-1 font-wt-600 leading-8">{price}</h1>
