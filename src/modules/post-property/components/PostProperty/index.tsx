...
// const fileToBase64 = (files: FileList) => {
//   const returnFiles = [];
//   for (const file of files) {
//     const reader = new FileReader();
//     reader.readAsDataURL(file);
//     reader.onloadend = () => {
//       returnFiles.push(reader.result);
//     };
//   }
//   return returnFiles;
// };
            ...
            <>
              ...
              <div className="px-24  flex mt-12 flex-wrap gap-12 ">
                ...
                <div className="flex flex-col ">
                  ...
                  <input type="number" id="sqft" className="  border-2 px-4 py-2 mt-4 text-fs-0.7 font-primaryRegular rounded-md outline-none" {...register('squareArea')} placeholder={heros.body.firstForm.sqft} />
                ...
                <div className="flex flex-col ">
                  ...
                  <input type="number" id="price" className="  border-2 px-4 py-2 mt-4 text-fs-0.7 font-primaryRegular rounded-md outline-none" {...register('price')} placeholder={heros.body.firstForm.price} />
                  {errors?.price && <p className=" font-primaryRegular text-red text-fs-0.7">{errors.price.message}</p>}
                </div>
                <div className="flex flex-col ">
                  <label htmlFor="bathrooms">Bathrooms :</label>
                  <input type="number" id="bathrooms" className="  border-2 px-4 py-2 mt-4 text-fs-0.7 font-primaryRegular rounded-md outline-none" {...register('bathrooms')} placeholder={heros.body.firstForm.bathrooms} />
                  {errors?.bathrooms && <p className=" font-primaryRegular text-red text-fs-0.7">{errors.bathrooms.message}</p>}
                </div>
                <div className="flex flex-col ">
                  <label htmlFor="bedrooms">Bedrooms :</label>
                  <input type="number" id="bedrooms" className="  border-2 px-4 py-2 mt-4 text-fs-0.7 font-primaryRegular rounded-md outline-none" {...register('bedrooms')} placeholder={heros.body.firstForm.bedrooms} />
          ...
          <>
            ...
            <div className="px-24  flex mt-12  flex-wrap gap-12 ">
              ...
              <div className="flex flex-col ">
                ...
                <input type="number" id="coordinates" className="  border-2 px-2 py-2 mt-4 text-fs-0.7 font-primaryRegular rounded-md outline-none" {...register('coordinate1')} placeholder={heros.body.secondForm.coordinates.lat} />
                {errors?.coordinate1 && <p className=" font-primaryRegular text-red text-fs-0.7">{errors.coordinate1.message}</p>}
                <input type="number" id="coordinates" className="  border-2 px-2 py-2 mt-4 text-fs-0.7 font-primaryRegular rounded-md outline-none" {...register('coordinate2')} placeholder={heros.body.secondForm.coordinates.long} />
